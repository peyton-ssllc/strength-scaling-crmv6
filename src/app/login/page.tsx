...
function LoginForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="card w-full max-w-md p-7">
      <div className="mb-6 grid size-12 place-items-center rounded-lg bg-sky-400/12 text-sky-300">
      ...
      {error ? (
        <div className="mt-4 rounded-lg border border-red-300/30 bg-red-400/10 p-3 text-sm text-red-100">
          {error}
        </div>
      ) : null}
