...
export default async function PipelineClientsPage() {
  ...
  return (
    <>
      <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><PageHeader eyebrow="Pipeline & Clients" title="Potential client tracker" description="Track warm accounts, follow-ups, booked opportunities, and client handoff candidates." /><Link href="/pipeline-clients/new" className="btn"><Plus className="size-4" /> New Account</Link></div>
